...
namespace BasicWebServer.Server.HTTP
{
    public class Session
    {
        ...
        // правим си един индексатор, за да може да може да вадим информация от дикшинърито в класа.
        // този this е текущата инстанция на този класа (Session) - малко рефлекшън
        // та, на session може отзада да слагаме квадратни скоби [] и да подаваме нещо (защото тя е уж някаква колекция)
